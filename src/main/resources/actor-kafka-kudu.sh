...
# chmod +x /etc/init.d/actor-kafka-kudu
# chkconfig --add /etc/init.d/actor-kafka-kudu
# chkconfig actor-kafka-kudu on
#
# Installation (Ubuntu):
# copy file to /etc/init.d
...
#
# Usage: (as root)
# service actor-generator start
# service actor-generator stop
# service actor-generator status
#
###
